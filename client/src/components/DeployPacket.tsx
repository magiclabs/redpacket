...
import { parseEther, encodeDeployData, Hash, getContractAddress, fromHex } from "viem";

export default function DeployPacket() {
    const { isLoggedIn, login, logout, username, scaAddress, userBalance, provider, walletClient } = useWalletContext();
            ...
            <div className="card w-96 bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                <input
                  ...
                  placeholder="0.05"
                />
                <button onClick={handleDeploy} className="btn btn-primary btn-lg mt-3">
                  Create Red Packet
                </button>
              </div>
            </div>
