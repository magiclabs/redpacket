...
export default function PacketClosed({ contractAddress }: PacketClosedProps) {
    ...
    const { totalClaimCount, claimedCount, currentBalance, totalBalance, claimedAmount, handleClaim } = useRedPacket({ contractAddress });
            ...
            <figure><img src="/red-packet.png" alt="Red Packet" /></figure>
                {claimedAmount ? (
                    <div className="card-body">
                        ...
                        <div className="font-bold">{formatEtherDisplay(claimedAmount)} ETH</div>
                    </div>
                ) : (
                    <div className="card-body">
