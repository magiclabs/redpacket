...
export default function Home() {
  ...
  const link = `${URL.replace(`https://`, '')}/claim/0x1234`
      ...
      <div className="flex w-full max-w-[440px] flex-col px-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-base">
            <span className="">10 packets</span>
            <div className="h-1 w-1 rounded-full bg-white opacity-30" />
            <span className="">0.02 ETH</span>
          </div>
        </div>
        ...
        <div className="mt-5 flex gap-3">
          ...
          <Button className="h-10 flex-1 gap-2 bg-[#FFFFFF1F] hover:bg-[#FFFFFF33]">
            View contract
            <ExternalIcon />
          </Button>
        </div>
