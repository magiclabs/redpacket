...
export default function Home() {
  return (
    ...
    >
      ...
      <Image
        priority
        className="aspect-square h-56 w-56 rotate-[30deg] md:h-64 md:w-64"
      ...
      <div className="flex flex-col gap-5 px-2">
        ...
        <span className="max-w-[468px] text-center text-sm text-white opacity-80 sm:text-lg">
      ...
      <div className="flex w-full max-w-[440px] flex-col justify-center gap-5 px-5">
        <Button className="h-14 w-full min-w-[336px] max-w-[400px] rounded-2xl bg-[#FF191E] text-lg font-semibold">
          Connect Wallet
        </Button>

        <div className="flex items-center gap-4">
          <hr className="flex-1 bg-white opacity-20" />
          ...
          >
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop offset="0.197241" stop-color="white" />
